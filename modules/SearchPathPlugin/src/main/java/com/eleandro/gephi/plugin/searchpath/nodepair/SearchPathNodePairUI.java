...
public class SearchPathNodePairUI implements StatisticsUI {
    ...
    public void setup(Statistics statistics) {
        ...
        if (panel != null) {
            panel.setPathNumber(myMetric.getPathNumber());
            panel.setMergePath(myMetric.getMergePath());
            panel.setPathOnReport(myMetric.getPathOnReport());
        }
    }
    ...
    public void unsetup() {
        if (panel != null) {
            myMetric.setPathNumber(panel.getPathNumber());
            myMetric.setMergePath(panel.getMergePath());
            myMetric.setPathOnReport(panel.getPathOnReport());
        }
        panel = null;
    }
